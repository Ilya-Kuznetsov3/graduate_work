...
void System::setup_system() {
  ...
  void System::assemble_system() {
    ...
    MatrixTools::apply_boundary_values(boundary_values, system_matrix,
                                       incremental_displacement, system_rhs, false);
  }
...
void System::solve_system() {
  ...
  solver.solve(system_matrix, incremental_displacement, system_rhs, preconditioner);
...
void System::setup_history() {
  ...
  history.clear();
  history.resize(triangulation.n_active_cells() * quadrature_formula.size());
